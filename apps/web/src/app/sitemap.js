...
export default async function sitemap() {
  ...
  const routes = [
    ...
    {
      url: `${siteUrl}/blog/publish-and-install`,
      changeFrequency: "monthly",
      priority: 0.5,
    },
    {
      url: `${siteUrl}/blog/agent-ready-components`,
      changeFrequency: "monthly",
      priority: 0.5,
    },
  ];
  ...
  try {
    ...
    const response = await fetchAllComponentsForSitemap({
    ...
    console.warn(
      "Dynamic component routes are temporarily unavailable for the sitemap."
    );
  }
