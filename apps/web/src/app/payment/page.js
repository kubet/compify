    ...
    return (
        <>
            ...
            <div className="relative flex h-[calc(100vh-72px)] flex-col items-center justify-center px-4 mx-auto w-full max-w-7xl sm:overflow-visible overflow-hidden">
                <GradientSpot color={success === 'true' ? 'hsl(131.63deg 50.8% 67.08%)' : 'hsl(359.99deg 50.8% 67.08%)'} size={500} position={{ x: '25%', y: '0%' }} opacity={0.15} />
                ...
                {/* cta got to create */}
                {success === 'true' ?
                    <Button className="mt-8" text="Start Creating" onClick={() => router.push('/create')} /> :
                ...
                <p className="text-gray-400 w-full mt-8 text-center">
                    Need help? <a href="mailto:support@compify.app" className="text-purple-500 hover:text-purple-400 transition-colors">Contact us support@compify.app</a>
                </p>
