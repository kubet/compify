...
function ComponentLimit({ isOpen, onClose }) {
            ...
            <div className="flex flex-col items-center justify-center px-4 sm:px-8 mx-auto w-full py-4" onClick={(e) => e.stopPropagation()}>
                ...
                >
                    ...
                    <p className="text-gray-400 mb-8 text-lg">
                        You&apos;ve reached the maximum number of components available in your current plan. Upgrade to create more awesome components.
                    </p>
