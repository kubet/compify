        ...
        <div className="flex bg-black text-white items-center justify-center" style={{ height: 'calc(100vh - 72px)' }}>
                ...
                <div className="flex items-center justify-between gap-3 relative z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm font-medium text-gray-200">
                            For the best experience, use a Chromium-based browser with a desktop.
                        </p>
                    </div>
                    <div className="cursor-pointer p-2" onClick={() => setShowBanner(false)}><X size={18} className="text-gray-200" /></div>
                </div>
            </motion.div>}
            <motion.div
            ...
            >
                ...
                <div className="hidden md:block">
                    <GradientSpot color="#0066ff" size={500} position={{ x: '-30%', y: '-30%' }} opacity={0.15} />
                    <GradientSpot color="#00ffff" size={500} position={{ x: '30%', y: '30%' }} opacity={0.15} />
                </div>
                <div className="block md:hidden">
                    <GradientSpot color="#0066ff" size={250} position={{ x: '-15%', y: '-15%' }} opacity={0.15} />
                    <GradientSpot color="#00ffff" size={250} position={{ x: '15%', y: '15%' }} opacity={0.15} />
                </div>
                ...
                <div className="w-full space-y-8 relative z-10 max-w-[400px]">
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                        <h2 className="text-4xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Welcome Back</h2>
                    ...
                    <p className="text-center text-gray-400 text-sm">
                        Don&apos;t have an account? <a href="/register" className="text-blue-400 hover:underline">Sign up with email</a>
                    </p>
                </div>
            </motion.div>
        </div>
