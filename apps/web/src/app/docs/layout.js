      ...
      <RootProvider theme={{ defaultTheme: 'dark', forcedTheme: 'dark' }}>
        <DocsLayout
          ...
          links={[
            ...
            { text: 'API Reference', url: '/docs/api-reference', icon: <Code2 /> },
            { text: 'GitHub', url: 'https://github.com/vukasinkubet/compify', icon: <Github />, external: true },
          ]}
          sidebar={{
            banner: (
          ...
          githubUrl="https://github.com/vukasinkubet/compify"
        >
          {children}
        </DocsLayout>
      </RootProvider>
