...
const AnimatedBackground = React.memo(() => {
    ...
    return (
        <div className="pointer-events-none absolute inset-0 h-[900px] overflow-hidden" aria-hidden="true">
...
function Hero() {
    ...
    return (
        <section className="w-full min-h-[calc(100svh-4rem)] py-12 sm:py-16 flex items-center justify-between" aria-labelledby="landing-heading">
            <AnimatedBackground />
            ...
            >
                <div className="text-left w-full max-w-[54rem]">
                    ...
                    <motion.div className="space-x-4 flex items-center justify-start" variants={fadeIn}>
                        <Button text="Start building" textSm='Start' variant="full" href="/register" />
                        <Button text="Watch the demo" textSm='Demo' variant="outline" href="/#demo" />
                    </motion.div>
                </div>
