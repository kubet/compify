...
const apiClient = {
    async generateCode(prompt, initialCode, endpoint, language, id, usedUiFrameworks, images, signal) {
        ...
        const response = await fetch(baseUrl + endpoint, {
            ...
            body: JSON.stringify({ prompt, initialCode, language, id, usedUiFrameworks, images }),
            signal
        });
...
export function useAI() {
    ...
    const generateCode = useCallback(async (prompt, initialCode, onResponseUpdate, endpoint, language, id, usedUiFrameworks, images) => {
        if (!prompt.trim()) {
