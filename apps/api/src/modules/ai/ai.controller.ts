...
export class AiController {
  ...
  async completion(
    ...
    return await this.aiService.completion(b, res, user);
  }

  @UseGuards(SubscriptionThrottlerGuard)
  @Post('completion/input')
  async completionInput(@Body() b: any, @GetUser() user: User) {
    return await this.aiService.completionInput(b, user);
  }
  ...
  @UseGuards(SubscriptionThrottlerGuard)
  @Post('component-name')
  async generateComponentName(@Body() b: any, @GetUser() user: User) {
    return await this.aiService.generateComponentName(b, user);
  }
}
