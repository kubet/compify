...
import { addDays, addMonths, endOfDay, getDaysInMonth, startOfDay, subMonths } from 'date-fns';
...
export class UsageResetService {
  ...
  private async handleSubscriptionExpiration() {
    ...
    try {
      ...
      this.logger.error('Failed to process subscription expirations', error.stack);
      throw error;
    }
  }
