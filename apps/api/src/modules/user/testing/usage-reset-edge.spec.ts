import { subMonths, isSameDay, startOfDay } from 'date-fns';
...
describe('Usage Reset Edge Cases', () => {
  ...
  const testCases = [
    {
      ...
      shouldReset: true,
      explanation: "Exactly one month passed, should reset regardless of original time"
    },
    {
      ...
      shouldReset: true,
      explanation: "Jan 31 -> Feb 29 (leap year), should reset on last day of shorter month"
    },
    {
    ...
    },
    {
      ...
      shouldReset: true,
      explanation: "Same day different time should still reset (we ignore time)"
    },
    {
    ...
    },
    {
      ...
      shouldReset: true,
      explanation: "First reset after subscription start, should reset on same day next month"
    },
    {
    ...
    },
    {
      ...
      shouldReset: true,
      explanation: 'Mar 31 -> Apr 30, should reset on last day of shorter month',
    },
  ];
  ...
  testCases.forEach(testCase => {
    it(testCase.case, () => {
      ...
      const lastResetDate = testCase.lastResetDate ? new Date(testCase.lastResetDate) : null;
