...
packages and compatibility contracts.
...
- Hashed password-reset and CLI tokens, traversal and XSS defenses, fail-closed production secrets, pinned CI actions and container images, dependency audits, and CodeQL analysis.
