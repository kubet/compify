...
function addPackageJSONIfNeeded(files, dependencies, devDependencies, entry) {
    ...
    if (packageJsonFile) {
        ...
        if (dependencies) {
            packageJsonContent.dependencies = tslib_es6.__assign(tslib_es6.__assign({}, ((_a = packageJsonContent.dependencies) !== null && _a !== void 0 ? _a : {})), (dependencies !== null && dependencies !== void 0 ? dependencies : {}));
        }
        if (devDependencies) {
            packageJsonContent.devDependencies = tslib_es6.__assign(tslib_es6.__assign({}, ((_b = packageJsonContent.devDependencies) !== null && _b !== void 0 ? _b : {})), (devDependencies !== null && devDependencies !== void 0 ? devDependencies : {}));
        }
        if (entry) {
