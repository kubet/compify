...
var base = require('../../base-7e8d162e.js');
...
var Protocol = /** @class */ (function () {
    function Protocol(type, handleMessage, protocol) {
        ...
        this._disposeMessageListener = this.protocol.channelListen(function (msg) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
...
var IFrameProtocol = /** @class */ (function () {
    ...
    IFrameProtocol.prototype.dispatch = function (message) {
        ...
        this.frameWindow.postMessage(tslib_es6.__assign({ $id: this.channelId, codesandbox: true }, message), this.origin);
    };
...
var entries = Object.entries(mimeDB__default["default"]);
...
modules) {
    ...
    var totalDependencies = tslib_es6.__spreadArray(tslib_es6.__spreadArray([], Object.keys(dependencies), true), Object.keys(devDependencies), true);
...
var SandpackRuntime = /** @class */ (function (_super) {
    tslib_es6.__extends(SandpackRuntime, _super);
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        _this.unsubscribeGlobalListener = _this.iframeProtocol.globalListen(function (mes) {
            ...
            if (_this.options.fileResolver) {
                _this.fileResolverProtocol = new Protocol("fs", function (data) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
                    return tslib_es6.__generator(this, function (_a) {
            ...
            switch (mes.type) {
                ...
                case "action": {
                    if (mes.action === "show-error") {
                        _this.errors = tslib_es6.__spreadArray(tslib_es6.__spreadArray([], _this.errors, true), [utils.extractErrorDetails(mes)], false);
                    }
                    break;
                }
                case "done": {
    ...
    SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
        ...
        this.sandboxSetup = tslib_es6.__assign(tslib_es6.__assign({}, this.sandboxSetup), sandboxSetup);
        var files = this.getFiles();
        var modules = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return (tslib_es6.__assign(tslib_es6.__assign({}, prev), (_a = {}, _a[next] = {
        ...
        this.dispatch(tslib_es6.__assign(tslib_es6.__assign({}, this.options), { type: "compile", codesandbox: true, version: 3, isInitializationCompile: isInitializationCompile, modules: modules, reactDevTools: this.options.reactDevTools, externalResources: this.options.externalResources || [], hasFileResolver: Boolean(this.options.fileResolver), disableDependencyPreprocessing: this.sandboxSetup.disableDependencyPreprocessing, experimental_enableServiceWorker: this.options.experimental_enableServiceWorker, template: this.sandboxSetup.template ||
    ...
    SandpackRuntime.prototype.getCodeSandboxURL = function () {
        ...
        var paramFiles = Object.keys(files).reduce(function (prev, next) {
            var _a;
            return (tslib_es6.__assign(tslib_es6.__assign({}, prev), (_a = {}, _a[next.replace("/", "")] = {
                content: files[next].code,
                isBinary: false,
            }, _a)));
        }, {});
